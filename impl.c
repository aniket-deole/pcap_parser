...
int construct_pkt_list (char* filter) {
  pcap_t* dump_file = pcap_open_offline ("/home/aniket/projects/networks/pcap_parser/tcpdump_for_lte_tool_16Nov/tcpdump_for_lte_tool_16Nov/second_aws.pcap", errbuf);
  if (dump_file == NULL) {
    return -1;
  }
